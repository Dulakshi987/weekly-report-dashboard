          ...
          <tbody>
            {tasks.map((t) => (
              <tr key={t.id}>
                ...
                <td style={styles.td}>
                  {t.time_planned_hours}/{t.time_spent_hours}
                </td>
        ...
        <div style={styles.addRow}>
          ...
          <input
            ...
            onChange={(e) =>
              setNewTask({
                ...newTask,
                planned_percent: Number(e.target.value),
              })
            }
          ...
          <input
            ...
            onChange={(e) =>
              setNewTask({
                ...newTask,
                actual_percent: Number(e.target.value),
              })
            }
            style={styles.inputTiny}
          />
          ...
          <input
            ...
            onChange={(e) =>
              setNewTask({
                ...newTask,
                time_planned_hours: Number(e.target.value),
              })
            }
            style={styles.inputTiny}
          />
          ...
          <input
            ...
            onChange={(e) =>
              setNewTask({
                ...newTask,
                time_spent_hours: Number(e.target.value),
              })
            }
            style={styles.inputTiny}
          />
