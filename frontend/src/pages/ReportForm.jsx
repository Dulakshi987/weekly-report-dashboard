    ...
    <DashboardLayout>
      ...
      {latestComment && status === "needs_correction" && (
        <div style={styles.commentBox}>
          <strong>
            Manager's comment (needs correction):
          </strong>
      ...
      {!canEdit && (
        <div style={styles.infoBox}>
          This report is <strong>{status}</strong> and can no
          longer be edited.
        </div>
      )}
      ...
      <form onSubmit={handleSave} style={styles.form}>
        ...
        <textarea
          value={tasksPlanned}
          onChange={(e) =>
            setTasksPlanned(e.target.value)
          }
          disabled={!canEdit}
        ...
        <>
          ...
          {canEdit && (
            <div style={styles.submitSection}>
              ...
              <p style={styles.note}>
                Once submitted, your manager will review
                this report and can approve it or send it
