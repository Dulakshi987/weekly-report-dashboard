...
function usePagedList(items, pageSize = ROWS_PER_PAGE) {
...
export default function ReportDetail() {
  ...
  async function handleReview(action) {
    if (
      ...
      alert(
        "Please enter a comment explaining what needs correction"
      );
      return;
    }
      ...
      <div style={styles.page}>
          ...
          <div style={styles.headerTop}>
            <div>
              ...
              <h1 style={styles.headerTitle}>
                {report.week_start?.slice(0, 10)}

                <span style={styles.arrow}> → </span>

                {report.week_end?.slice(0, 10)}
              </h1>
            </div>
            ...
            <>
              <div style={styles.tableWrap}>
                <table style={styles.table}>
                  ...
                  <tbody>
                    {achievementPager.paginated.map(
                      (a, idx) => (
                        <tr
                          key={a.id}
                          style={
              ...
              {achievements.length >
                ...
                <Pagination
                  ...
                  totalPages={
                    achievementPager.totalPages
                  }
                  onChange={
                    achievementPager.setPage
                  }
        ...
        {hoursBreakdown.length > 0 && (
          <div style={styles.section}>
            ...
            {hoursBreakdown.length >
              ROWS_PER_PAGE && (
              <Pagination
                page={hoursPager.page}
                totalPages={
                  hoursPager.totalPages
                }
...
const styles = {
  ...
  section: {
    ...
    boxShadow:
      "0 2px 8px rgba(15, 23, 42, 0.04), 0 1px 2px rgba(15, 23, 42, 0.02)",
  },
